...
def main():
    ...
    for in-scope databases. It does so by checking the configurations of AWS RDS and CloudWatch Logs,
    ...
    for env_name, config in environments.items():
        ...
        # Define the AWS CLI commands to gather evidence of audit log settings and recent logs for RDS
        aws_commands = [
            [
            ...
            [
                ...
                '--region', config.region, '--db-instance-identifier', '<your-db-instance-identifier>',
                '--output', 'json'
            ],
            [
                'aws', 'logs', 'filter-log-events',
                '--log-group-name', '/aws/rds/instance/<your-db-instance-identifier>/audit',
