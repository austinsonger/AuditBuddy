...
Description:
    Checks whether Amazon Elasticsearch Service (Amazon ES) domains have encryption at rest configuration enabled. The resource is NON_COMPLIANT if encryption at rest is not enabled.
Trigger:
    Periodic
Reports on:
...
Scenarios:
  ...
  Scenario: 2
     ...
     Given: Enabled field is true in EncryptionAtRestOptions
     Then: Return COMPLIANT
  Scenario: 3
     Given: At least one Elasticsearch Service Domain is present
     Given: Enabled field is false in EncryptionAtRestOptions
