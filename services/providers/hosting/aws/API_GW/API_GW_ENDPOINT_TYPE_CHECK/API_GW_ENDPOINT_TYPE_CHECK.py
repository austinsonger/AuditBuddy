...
"""
Description:
  Checks that Amazon API Gateway APIs are of type as specified in the rule parameter 'endpointConfiguration Type'. The rule returns NON_COMPLIANT if the RestApi does not match the endpoint type configured in the rule parameter.

Trigger:
  Configuration Change on AWS::ApiGateway::RestApi
...
Scenarios:
  ...
  Scenario: 2
    Given: The rule parameter is invalid
     Then: Return ERROR
  Scenario: 3
    Given: The rule parameter is provided and valid
      And: The endpointConfiguration type in the RestApi configuration item does not match the endpoint type in rule parameter.
     Then: Return NON_COMPLIANT
  Scenario: 4
    Given: The rule parameter is provided and valid
      And: The endpointConfiguration type in the RestApi configuration item matches the endpoint type in rule parameter.
