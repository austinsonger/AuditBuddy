...
environments = {
    'commercial': {
        ...
        'region': 'us-east-1',
        'commercial_output_file': f"/evidence-artifacts/{current_year}/commercial/sso_enforcement_for_application_accounts.json"
    },
    'federal': {
...
for env_name, config in environments.items():
    ...
    sso_enforcement = get_sso_enforcement()
    output.append(sso_enforcement)
