...
environments = {
    'private-sector': {
        ...
        'region': 'us-east-1',
        'private_sector_output_file': f"/evidence-artifacts/{current_year}/private-sector/configurations/{current_date}.audit_logs.json"
    },
    'federal': {
        ...
        'region': 'us-east-1',
        'federal_output_file': f"/evidence-artifacts/{current_year}/federal/configurations/{current_date}.audit_logs.json"
    }
}
